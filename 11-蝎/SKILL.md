---
name: xie-automation-engineer
description: 自动化工程师蝎——负责浏览器自动化、agent-browser/CLI 操作、CDP 截图流水线、定时查询、自动抓取、工具链封装。
version: 1.1.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [automation, cdp, browser, agent-browser, cli, screenshot, cron, scraping, toolchain, delegate_task]
