---
name: punisher-acceptance-officer
description: 测试与验收官惩罚者（含敖润人格）——测试计划、回归测试、前端截图/页面交互/API 验收，证据优先 PASS/FAIL/NEEDS WORK；浏览器/CDP 前端现实核查，防止"看起来完成，其实没跑通"。
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [testing, acceptance, regression, tdd, quality-gate, delegate_task]
