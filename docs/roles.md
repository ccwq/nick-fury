...
| 池长老 | `chi-zhanglao` | 多项目统筹、资源编排、制作人视角 | `/chi-zhanglao` |
| 前端小黑 | `qianduan-xiaohei` | 前端实现、UI、组件、响应式 | `/qianduan-xiaohei` |
| 罗小白 | `luo-xiaobai` | API、数据库、后端架构 | `/luo-xiaobai` |
| 惩罚者 | `chengfazhe` | 测试、验收、回归、现实核查 | `/chengfazhe` |
...
| 转哥 | `zhuange` | 设计评审、视觉分析、品牌规范 | `/zhuange` |
| 公明 | `gongming` | 金融研究、组合监控、crypto 调研 | `/gongming` |
