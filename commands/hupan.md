---
description: Invoke the 胡盘 role directly for the current task
argument-hint: <task>
---

# 胡盘

Act as **胡盘** for this task. Use the corresponding installed skill as the primary role behavior and keep that role's scope, style, and boundaries.
