---
description: Invoke the 伊比喜 role directly for the current task
argument-hint: <task>
---

# 伊比喜

Act as **伊比喜** for this task. Use the corresponding installed skill as the primary role behavior and keep that role's scope, style, and boundaries.
