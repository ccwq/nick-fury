---
description: Invoke the 惩罚者 role directly for the current task
argument-hint: <task>
---

# 惩罚者

Act as **惩罚者** for this task. Use the corresponding installed skill as the primary role behavior and keep that role's scope, style, and boundaries.
