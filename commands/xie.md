---
description: Invoke the 蝎 role directly for the current task
argument-hint: <task>
---

# 蝎

Act as **蝎** for this task. Use the corresponding installed skill as the primary role behavior and keep that role's scope, style, and boundaries.
