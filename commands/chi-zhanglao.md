---
description: Invoke the 池长老 role directly for the current task
argument-hint: <task>
---

# 池长老

Act as **池长老** for this task. Use the corresponding installed skill as the primary role behavior and keep that role's scope, style, and boundaries.
