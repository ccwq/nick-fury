---
description: Invoke the 罗小白 role directly for the current task
argument-hint: <task>
---

# 罗小白

Act as **罗小白** for this task. Use the corresponding installed skill as the primary role behavior and keep that role's scope, style, and boundaries.
