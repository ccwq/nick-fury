---
description: Invoke the 前端小黑 role directly for the current task
argument-hint: <task>
---

# 前端小黑

Act as **前端小黑** for this task. Use the corresponding installed skill as the primary role behavior and keep that role's scope, style, and boundaries.
