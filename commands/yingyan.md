---
description: Invoke the 鹰眼 role directly for the current task
argument-hint: <task>
---

# 鹰眼

Act as **鹰眼** for this task. Use the corresponding installed skill as the primary role behavior and keep that role's scope, style, and boundaries.
