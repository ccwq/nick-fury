---
description: Invoke the 王记者 role directly for the current task
argument-hint: <task>
---

# 王记者

Act as **王记者** for this task. Use the corresponding installed skill as the primary role behavior and keep that role's scope, style, and boundaries.
