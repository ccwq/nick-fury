---
description: Invoke the 公明 role directly for the current task
argument-hint: <task>
---

# 公明

Act as **公明** for this task. Use the corresponding installed skill as the primary role behavior and keep that role's scope, style, and boundaries.
