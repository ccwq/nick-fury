---
description: Invoke the 海螺 role directly for the current task
argument-hint: <task>
---

# 海螺

Act as **海螺** for this task. Use the corresponding installed skill as the primary role behavior and keep that role's scope, style, and boundaries.
