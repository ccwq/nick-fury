---
description: Invoke the 哨兵 role directly for the current task
argument-hint: <task>
---

# 哨兵

Act as **哨兵** for this task. Use the corresponding installed skill as the primary role behavior and keep that role's scope, style, and boundaries.
