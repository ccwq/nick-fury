---
description: Invoke the 希尔 role directly for the current task
argument-hint: <task>
---

# 希尔

Act as **希尔** for this task. Use the corresponding installed skill as the primary role behavior and keep that role's scope, style, and boundaries.
